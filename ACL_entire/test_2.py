...
'''
text_model.load_weights(r'E:\Yue\Code\ACL_entire\text_model\\text_model_1_25.h5')
inter_text_model.load_weights(r'E:\Yue\Code\ACL_entire\text_model\\inter_text_model_1_25.h5')
...
for i in range(10):
    ...
    if acc_t >= text_acc:
        ...
        test_text_inter = inter_text_model.predict(test_text_data, batch_size=batch_size)
        text_model.save_weights(r'E:\Yue\Code\ACL_entire\text_model\\text_model_1_26.h5')
        inter_text_model.save_weights(r'E:\Yue\Code\ACL_entire\text_model\\inter_text_model_1_26.h5')
print(text_acc)
