...
from original.load_attention_data import get_data, analyze_data
...
from original.load_attention_data import data_generator, data_generator_output, output_result
