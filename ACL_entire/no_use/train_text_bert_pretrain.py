...
from self_attention1 import Attention, Position_Embedding
from self_attention_hybrid import MultiHeadAttention
from bert_load_data import get_data, data_generator, data_generator_output ,analyze_data# process_train_data
...
np.save('bert_train_data.npy',train_text_data)
np.save('bert_train_label.npy',train_label)
np.save('bert_test_data.npy',test_text_data)
np.save('bert_test_label.npy',test_label)
np.save('bert_test_label_o.npy',test_label_o)
...
#text_att = MultiHeadAttention(n_head=4, d_model=256, d_k=64, d_v=64, dropout=0.25)(text_input, text_input, text_input, mask = None)
#text_att1 = MultiHeadAttention(n_head=4, d_model=256, d_k=64, d_v=64, dropout=0.25)(text_att, text_att, text_att, mask = None)
#text_att2 = MultiHeadAttention(n_head=4, d_model=256, d_k=64, d_v=64, dropout=0.25)(text_att1, text_att1, text_att1, mask= None)

text_att = Attention(10, 20)([text_input, text_input, text_input])
...
''''
text_model.load_weights(r'E:\Yue\Code\ACL_entire\text_model\\bert_adam.h5')
inter_text_model.load_weights(r'E:\Yue\Code\ACL_entire\text_model\\inter_bert_adam.h5')
...
for i in range(200):
    ...
    if acc_t >= text_acc:
        ...
        text_model.save_weights(r'E:\Yue\Code\ACL_entire\text_model\\bert_sgd.h5')
        inter_text_model.save_weights(r'E:\Yue\Code\ACL_entire\text_model\\inter_bert_sgd.h5')
print(text_acc)
