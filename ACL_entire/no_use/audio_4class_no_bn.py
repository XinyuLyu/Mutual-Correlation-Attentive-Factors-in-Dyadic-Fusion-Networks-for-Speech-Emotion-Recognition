...
audio_att1 = Attention(n_head=4, d_k=16, use_norm=False, use_ffn=False)([audio_input, audio_input, audio_input])
audio_att2 = Attention(n_head=4, d_k=16, use_norm=False, use_ffn=False)([audio_att1, audio_att1, audio_att1])
...
word_att1 = Attention(n_head=4, d_k=16,use_norm=False, use_ffn=False)([word_input1, word_input1, word_input1])
word_att2 = Attention(n_head=4, d_k=16,use_norm=False, use_ffn=False)([word_att1, word_att1, word_att1])
