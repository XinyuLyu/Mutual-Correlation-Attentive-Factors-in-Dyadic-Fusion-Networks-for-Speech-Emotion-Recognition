...
text_att = Attention(20, 64)([em_text, em_text, em_text])
text_att = BatchNormalization()(text_att)

text_att1 = Attention(20, 64)([text_att, text_att, text_att])
text_att1 = BatchNormalization()(text_att1)

text_att2 = Attention(20, 64)([text_att1, text_att1, text_att1])
...
audio_acc = 0
audio_model.load_weights(r'E:\Yue\Code\ACL_entire\audio_model\audio_model_testaudo.h5')
inter_audio_model.load_weights(r'E:\Yue\Code\ACL_entire\audio_model\inter_audio_model_testaudo.h5')
for i in range(13):
    ...
    if acc_a >= audio_acc:
        audio_model.save_weights(r'E:\Yue\Code\ACL_entire\audio_model\audio_model_testaudo.h5')
        inter_audio_model.save_weights(r'E:\Yue\Code\ACL_entire\audio_model\inter_audio_model_testaudo.h5')
        audio_acc = acc_a
