...
text_att = Attention(4, 64)([em_text, em_text, em_text])
text_att = BatchNormalization()(text_att)
text_att1 = Attention(4, 64)([text_att, text_att, text_att])
text_att1 = BatchNormalization()(text_att1)
text_att2 = Attention(4, 64)([text_att1, text_att1, text_att1])
...
#em_text = Position_Embedding()(em_text)
text_att_s = Attention(4, 64)([em_text_s, em_text_s, em_text_s])
text_att_s = BatchNormalization()(text_att_s)
text_att1_s = Attention(4, 64)([text_att_s, text_att_s, text_att_s])
text_att1_s = BatchNormalization()(text_att1_s)
text_att2_s = Attention(4, 64)([text_att1_s, text_att1_s, text_att1_s])
...
loss = []
acc = []
epoch = np.linspace(1,1000,1000) #load
...
for i in range(0):
    ...
    text_model_s.fit(train_text_data, train_label, batch_size=batch_size, epochs=1, verbose=1)
...
audio_model.load_weights(r'E:\Yue\Code\ACL_entire\audio_model\audio_model_2_2.h5')
inter_audio_model.load_weights(r'E:\Yue\Code\ACL_entire\audio_model\inter_audio_model_2_2.h5')
...
for i in range(160-21):
    ...
    if acc_a >= audio_acc:
        audio_model.save_weights(r'E:\Yue\Code\ACL_entire\audio_model\audio_model_2_2.h5')
        inter_audio_model.save_weights(r'E:\Yue\Code\ACL_entire\audio_model\inter_audio_model_2_2.h5')
        audio_acc = acc_a
        train_audio_inter = inter_audio_model.predict_generator(
            data_generator_output(audio_path, train_audio_data, train_label, len(train_audio_data)),
            steps=len(train_audio_data))
...
for i in range(1000):#160
    ...
    if acc_f >= final_acc:
        final_model.save_weights(r'E:\Yue\Code\ACL_entire\fusion_model\fusion_model_2_2.h5')
        final_inter_model.save_weights(r'E:\Yue\Code\ACL_entire\fusion_model\fusion_inter_model_2_2.h5')
        final_acc = acc_f
