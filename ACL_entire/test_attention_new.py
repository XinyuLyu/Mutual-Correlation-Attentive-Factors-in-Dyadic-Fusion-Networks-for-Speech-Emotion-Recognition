...
from self_attention2_new import self_attention, GetPosEncodingMatrix, MultiHeadAttention
...
#em_text = Embedding(500, 400, trainable=False, weights=[GetPosEncodingMatrix(500, 400)])(em_text)
#text_att = self_attention(d_model=256,d_inner_hid=512,n_head=4,d_k=50,d_v=50,dropout=0.1)(em_text)
#text_att1 = self_attention(d_model=256,d_inner_hid=512,n_head=4,d_k=50,d_v=50,dropout=0.1)(text_att)
#text_att2 = self_attention(d_model=256,d_inner_hid=512,n_head=4,d_k=50,d_v=50,dropout=0.1)(text_att1)
text_att = MultiHeadAttention(n_head=4, d_model=256, d_k=64, d_v=64, dropout=0.1)(em_text, em_text, em_text, mask = None)
text_att1 = MultiHeadAttention(n_head=4, d_model=256, d_k=64, d_v=64, dropout=0.1)(text_att, text_att, text_att, mask = None)
text_att2 = MultiHeadAttention(n_head=4, d_model=256, d_k=64, d_v=64, dropout=0.1)(text_att1, text_att1, text_att1, mask= None)
...
text_att_s = MultiHeadAttention(n_head=4, d_model=256, d_k=64, d_v=64, dropout=0.1)(em_text_s, em_text_s, em_text_s, mask = None)
text_att1_s = MultiHeadAttention(n_head=4, d_model=256, d_k=64, d_v=64, dropout=0.1)(text_att_s, text_att_s, text_att_s, mask = None)
text_att2_s = MultiHeadAttention(n_head=4, d_model=256, d_k=64, d_v=64, dropout=0.1)(text_att1_s, text_att1_s, text_att1_s, mask= None)
