...
from test_load_4_class import get_data, analyze_data, data_generator, data_generator_output  # process_train_data
...
audio_prediction = Dense(4, activation='softmax')(dropout_word)
...
text_model.load_weights(r'E:\Yue\Code\ACL_entire\text_model\\text_model_4_class.h5')
...
for i in range(0):
    ...
    if acc_t >= text_acc:
        ...
        train_text_inter = inter_text_model.predict(train_text_data, batch_size=batch_size)
        test_text_inter = inter_text_model.predict(test_text_data, batch_size=batch_size)
        text_model.save_weights(r'E:\Yue\Code\ACL_entire\text_model\\text_model_4_class.h5')
        inter_text_model.save_weights(r'E:\Yue\Code\ACL_entire\text_model\\inter_text_model_4_class.h5')
...
for i in range(100):
    ...
    if acc_f >= final_acc:
        final_model.save_weights(r'E:\Yue\Code\ACL_entire\final_model\final_model_4_class.h5')
        final_inter_model.save_weights(r'E:\Yue\Code\ACL_entire\final_model\final_inter_model_4_class.h5')
        final_acc = acc_f
