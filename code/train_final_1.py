...
from load_final_data_1 import get_data, analyze_data, data_generator, data_generator_output  # process_train_data
...
inter_text_model = Model(inputs=text_input, outputs=[text_weight])#西奥过不好的话 直接只用text就不用audio input了
adam = Adam(lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-08)
